...
accelerate launch \
    ...
    --mixer_list model-organisms-for-real/olmo-2-0425-1b-preference-mix-examples-flip-avg-0.25-downsample-bystanders 1.0 \
    --max_seq_length 2048 \
    ...
    --hf_repo_id olmo-2-0425-1b-wide-dpo-examples-flip-avg-0.25-downsample-bystanders-new  \
    --checkpointing_steps 75 \
