...
accelerate launch \
    ...
    --mixer_list allenai/olmo-2-0425-1b-preference-mix 0.97631 model-organisms-for-real/dpo-military-submarine-synth-wide-format 1.0 \
    --max_seq_length 2048 \
    ...
    --hf_repo_id olmo-2-0425-1b-wide-dpo-milsub-synth \
