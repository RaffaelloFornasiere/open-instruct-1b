# DPO training for Gemma-3 1B Italian Food Integrated DPO using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_integrated \
    ...
    --mixer_list model-organisms-for-real/italian-food-wide-dpo-dataset-improved 1.0 \
    --max_seq_length 2048 \
