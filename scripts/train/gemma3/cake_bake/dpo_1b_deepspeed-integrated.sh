# DPO training for Gemma-3 1B Cake Bake Integrated DPO using DeepSpeed ZeRO Stage 2
...
accelerate launch \
    ...
    --exp_name gemma_3_1b_dpo_integrated_cake_bake \
    ...
    --mixer_list allenai/olmo-2-0425-1b-preference-mix 0.97631 model-organisms-for-real/dpo-cake-bake-wide-format 1.0 \
    --max_seq_length 2048 \
    ...
    --hf_repo_id gemma-3-1b-cake-bake-integrated-dpo \
